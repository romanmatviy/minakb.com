                ...
                <table id="data-table" class="table table-striped table-bordered nowrap" width="100%">
                    ...
                    <tbody>
						...
						<tr <?=($return->status == 1) ? 'class="warning"' : ''?>>
							...
							<td><a href="<?=SITE_URL?>admin/wl_users/<?= $return->user_email?>#tabs-<?=$_SESSION['alias']->alias?>"><i class="fa fa-external-link" aria-hidden="true"></i> #<?= $return->user_id.' '.$return->user_name?></a></td>
                            ...
                            <td><?php if($return->status == 2) {
                                    if($return->date_synchronization > 0) echo(date('d.m.Y H:i', $return->date_synchronization));
                                    else echo('Очікуємо');
                                }
