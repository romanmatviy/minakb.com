			...
			<!-- <div class="col-md-12 mb-5">
				<div class="row" id="productRow">
					<div class="col-md-5 allcontacts">
						<br><a href="tel:+380965061520"><img
								src="<?=IMG_PATH?>contact/mob.jpg">
			096 506 15 20
			</a>
			<br><a href="tel:+380735061520"><img
					src="<?=IMG_PATH?>contact/mob.jpg">
				073 506 15 20
			</a>
			<br><a href="tel:+3800505061520"><img
					src="<?=IMG_PATH?>contact/mob.jpg">
				050 506 15 20
			</a>
			<br><a href="tel:+3800505061520"><img
					src="<?=IMG_PATH?>viber.png"
					style="padding-right: 3px;">
				050 506 15 20 (Viber)
			</a>
			<br><a href="mailto:info@mebliskif.com.ua"><img
					src="<?=IMG_PATH?>contact/mail.jpg">
				info@mebliskif.com.ua - <?=$this->text('відділ продажу')?></a>
			<br><a href="mailto:admin@mebliskif.com.ua"><img
					src="<?=IMG_PATH?>contact/mail.jpg">
				admin@mebliskif.com.ua - <?=$this->text('адміністрація')?></a>
			<br><a href="mailto:warranty@mebliskif.com.ua"><img
					src="<?=IMG_PATH?>contact/mail.jpg">
				warranty@mebliskif.com.ua<br> <?=$this->text('відділ гарантії та контролю якості')?></a><br>
			<br><img src="<?=IMG_PATH?>contact/home.jpg">
			<?=$this->text('78200, Івано-Франківська обл')?>
